/**
 * The <code>Dictionary</code> is an interface that provides the overall structure for dynamic sets
 * that support insert, delete and search. The type parameter V must be hashable.
 *
...
public interface Dictionary<V extends Hashable> {
     ...
     * @return <code>true</code> if the dictionary has no items, <code>false</code> otherwise.
     */
    boolean isEmpty();
    /**
